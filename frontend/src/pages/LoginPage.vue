<template>
  <div class="lt-auth-bg row items-center justify-center q-pa-md">
    <q-card class="lt-auth-card bg-white q-pa-lg">
      <div class="row items-center q-mb-lg">
        ...
        <div class="q-ml-md">
          ...
          <div class="text-caption text-grey-6">Sistema de Inventario</div>
        </div>
      </div>

      <div class="text-display text-h5 q-mb-xs">Bienvenido</div>
      <div class="text-body2 text-grey-6 q-mb-lg">Ingresa tus credenciales para continuar</div>
      ...
      <div class="text-caption text-grey-6 q-mb-xs">Credenciales de prueba</div>
